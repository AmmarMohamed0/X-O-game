...
class Menu:
    def display_main_menu(self):
        ...
        print("1. Start Game")
        print("2. Quit Game")
        choice = self.get_valid_input("Enter your choice (1 or 2):", ["1", "2"])
        return choice
    def display_endgame_menu(self):
        ...
        """
        choice = self.get_valid_input(menu_text, ["1", "2"])
        return choice
...
class Board:
    ...
    def update_board(self, choice, symbol):
        if self.is_valid_move(choice):
            ...
            return True    # returns True to indicate that the move was successful.
        return False   # returns False to indicate that the move couldn't be made.
...
class Game:
    ...
    def check_win(self):
        ...
        for combo in win_combinations:
            if (
                    self.board.board[combo[0]] == self.board.board[combo[1]]
